...
'''
This code generates a static plot of the out-of-sample prediction of a logistic regression model.
The data is generated using a logistic function with added noise, and the data is divided into three tritiles. 
'''
